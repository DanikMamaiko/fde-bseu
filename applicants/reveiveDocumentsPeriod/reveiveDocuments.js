const translations = {
    'ru': {
        ...
        'admission.title': 'Сроки приёма документов',
        'admission.date1': 'С 27 июня по 2 июля',
        'admission.text1': 'На условиях целевой подготовки',
        'admission.date2': 'С 12 июля по 17 июля (за счет средств республиканского бюджета)',
        'admission.text2.1': 'На очную(дневную) форму получения общего высшего образования.',
        'admission.text2.2': 'На заочную с сокращенным сроком обучения.',
        'admission.text2.3': 'На заочную с полным сроком обучения.',
        'admission.date3': 'С 12 июля по 17 июля (на платной основе для сдающих вступительные испытания в БГЭУ)',
        'admission.text3': 'На заочную с сокращенным сроком обучения',
        'admission.date4': 'С 12 июля по 1 августа (на платной основе для не сдающих вступительные испытания в БГЭУ)',
        'admission.text4.1': 'На очную (дневную) форму получения общего высшего образования.',
    ...
    'be': {
        ...
        'admission.title': 'Тэрміны прыёму дакументаў',
        'admission.date1': 'З 27 чэрвеня па 2 ліпеня',
        'admission.text1': 'На ўмовах цэлевай падрыхтоўкі',
        'admission.date2': 'З 12 ліпеня па 17 ліпеня (за кошт сродкаў рэспубліканскага бюджэту)',
        'admission.text2.1': 'На дзённую форму атрымання агульнай вышэйшай адукацыі.',
        'admission.text2.2': 'На завочную з скарочаным тэрмінам навучання.',
        'admission.text2.3': 'На завочную з поўным тэрмінам навучання.',
        'admission.date3': 'З 12 ліпеня па 17 ліпеня (на платнай аснове для тых, хто здае ўступныя выпрабаванні ў БДЭУ)',
        'admission.text3': 'На завочную з скарочаным тэрмінам навучання',
        'admission.date4': 'З 12 ліпеня па 1 жніўня (на платнай аснове для тых, хто не здае ўступныя выпрабаванні ў БДЭУ)',
        'admission.text4.1': 'На дзённую форму атрымання агульнай вышэйшай адукацыі.',
    ...
    'en': {
        ...
        'admission.title': 'Document submission deadlines',
        'admission.date1': 'June 27 - July 2',
        'admission.text1': 'For targeted training programs',
        'admission.date2': 'July 12 - July 17 (funded by the republican budget)',
        'admission.text2.1': 'For full-time general higher education programs.',
        'admission.text2.2': 'For part-time programs with reduced duration.',
        'admission.text2.3': 'For part-time programs with full duration.',
        'admission.date3': 'July 12 - July 17 (on fee-paying basis for applicants taking entrance exams at BSEU)',
        'admission.text3': 'For part-time programs with reduced duration',
        'admission.date4': 'July 12 - August 1 (on fee-paying basis for applicants not taking entrance exams at BSEU)',
        'admission.text4.1': 'For full-time general higher education programs.',
    ...
    'zh': {
        ...
        'admission.title': '文件提交截止日期',
        'admission.date1': '6月27日至7月2日',
        'admission.text1': '定向培养计划',
        'admission.date2': '7月12日至7月17日（由共和国预算资助）',
        'admission.text2.1': '全日制普通高等教育课程',
        'admission.text2.2': '缩短学制的非全日制课程',
        'admission.text2.3': '完整学制的非全日制课程',
        'admission.date3': '7月12日至7月17日（自费，需参加白俄罗斯国立经济大学入学考试）',
        'admission.text3': '缩短学制的非全日制课程',
        'admission.date4': '7月12日至8月1日（自费，无需参加白俄罗斯国立经济大学入学考试）',
        'admission.text4.1': '全日制普通高等教育课程',
