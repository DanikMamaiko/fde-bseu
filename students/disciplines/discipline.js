const translations = {
    ...
    'zh': {
        ...
        'disciplines.text3.part2': '专业培养具备在经济和社会生活各领域收集、处理、分析和解释数据知识与技能的专业人才。课程包括统计学理论、经济和社会统计、活动统计、金融、价格、人口统计及其他行业方向。特别关注关系的统计分析、多元统计方法、计量经济学建模方法、统计数据处理和可视化。学生学习统计信息系统、SQL语言、高级编程语言及商业分析工具。这些知识使毕业生能够进行综合统计研究，识别规律和趋势，制定预测和管理决策建议。',
